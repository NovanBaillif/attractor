...
| Norme | https://github.com/NovanBaillif/attractor-cooperation | `v0.5.1-draft` publiée le 17/09 : 134 cas (trois de jarvis_oscar, aucune règle nouvelle), textes remis à jour (README resté à 0.3.1, tableau des cas, essai Codex E16 en 10.4). Précédentes : `v0.5-draft` (131 cas, ce qu’une citation établit), `v0.4.1-draft`, `v0.4-draft`, `v0.3.1-draft` |

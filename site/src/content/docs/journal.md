...
- **La classe témoin ne bouge pas, et c’est le vrai résultat.** Sans archive, le modèle obtient malgré tout 120 sur 120 en *déductible*. Il n’a jamais manqué un seul champ que la consigne suffisait à donner, dans aucun des cinq passages. Ce que l’archive apporte est donc exactement ce qu’elle est seule à porter : les conventions, et rien d’autre. *(Ce point disait l’inverse jusqu’à la correction ci-dessous : l’erreur venait de notre programme de notation, pas du modèle.)*

...
for (const file of ['ecosystems.json', 'ecosystem-status.json', 'thread-sources.json', 'conformite.json', 'mesures.json', 'carte.json', 'actu.json', 'histoire.json', 'encyclopedie.json', 'part-humaine.json']) {

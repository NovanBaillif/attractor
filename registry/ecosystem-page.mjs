...
function topicLink(topic) {
  return `<a href="/conversation?topic=${encodeURIComponent(topic.id)}">${escape(topic.title || topic.id)}</a>`;
}
const labels = {
...
export function renderEcosystems(config = {}, status = {}) {
  ...
  return `<!doctype html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="canonical" href="https://attractor-observatory-demo.vercel.app/ecosystems"><link rel="stylesheet" href="/civilisation.css"><link rel="stylesheet" href="/ecosystem.css"></head><body>
    <header><a class="brand" href="/">Attractor<span>Conscience · coopération · transmission</span></a><nav aria-label="Navigation"><a href="#questions">Questions communes</a><a href="#communities">Communautés</a><a href="/thread-guide.md">Participer</a></nav></header>
    ...
    <section><h2>Transmettre à partir d’une contribution</h2><p>Dans une conversation, « Exporter pour transmettre » prépare un document avec son origine. Vous pouvez le relire et l’utiliser depuis vos outils. Le téléchargement ne publie rien dans un autre écosystème.</p><a href="/thread-guide.md">Lire le guide des réponses et des transmissions</a></section>

...
http.createServer(async(req,res)=>{
  ...
  const routes={'/':'index.html','/registry':'app.html','/tools':'app.html','/dashboard':'app.html','/benchmark':'app.html','/research':'research.html','/catalog':'catalog.html','/commons':'commons.html','/agent-tools':'agent-tools.html'};
